...
PRESERVE=(
  ...
  # Your capability decisions. An explicit switch-off has to survive an upgrade:
  # a new FDE version may add a default, it may not quietly undo one of yours.
  "config/capability-config.json"
  "config/capability-policy.json"   # the v1 file; still what fde-start reads
  "config/capability-events.jsonl"
...
CONFIRM=(
  ...
  # Which capability no layer may change is a security posture, and one you may
  # have tightened. A shipped change is shown as a diff, never applied silently.
